...
const unlinkedPagesController = new UnlinkedPagesController({
  unlinkedPageService,
})
const unlinkedPagesV2Router = new UnlinkedPagesRouter({
  unlinkedPagesController,
})
...
app.use("/v2/sites", unlinkedPagesV2Router.getRouter())
